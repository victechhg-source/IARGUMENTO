...
<TabsContent value="users"><InviteUser schools={data.schools} onInvited={load} /><UsersTab users={data.users} schools={data.schools} currentUserId={user?.id} onChanged={load} /></TabsContent>
<TabsContent value="classes"><ClassesTab classes={data.classes} memberships={data.memberships} /></TabsContent>
<TabsContent value="tests" className="space-y-5"><RoleTestPanel user={user} schools={data.schools} onChange={load} /><RoleTestPlaybook /></TabsContent>
<TabsContent value="audit"><AuditLogTab logs={data.auditLogs || []} schools={data.schools} /></TabsContent></Tabs></main></div>;
}